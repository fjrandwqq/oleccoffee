      ...
      >
        <div class="pullup-wrapper" v-if="pullUpLoad">
          ...
          <div class="after-trigger" v-else>
            <img src="@/images/personal/loading.gif">
          </div>
        </div>
      </slot>
    </div>
...
<script>
  ...
  import { getRect } from '@/services/utils'
  ...
  export default {
    ...
    /* watch: {
      data(val,oldVal) {
        setTimeout(() => {
          this.forceUpdate(oldVal.length!=val.length)
        }, this.refreshDelay)
      }
    }, */
    components: {
...
<style lang="less" scoped src="./Scroll.less"></style>